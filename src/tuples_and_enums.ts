 ...
 * Define a type alias named User with properties id (number), name (string), and role (UserRole),
 ...
 * Call the createUser function with an object matches the User type, store the result in a variable, and log the variable to the console
 */
...
const newUser: User = {
    ...
    name: 'M. A.',
    role: UserRole.Admin,
    contact: ['ma@gmail.com', '1234567890']
};
